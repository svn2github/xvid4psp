...
namespace XviD4PSP
{
	public partial class FormatSettings
	{
        ...
        private void SetTooltips()
        {
            ...
            check_fixed_ar.ToolTip = Languages.Translate("Use this option provided this format can have only specified (by next setting) AR");
            ...
            textbox_aspects.ToolTip = Languages.Translate("Valid values:")+ " 1.333 (4:3), 1.500, 1.666, 1.765 (16:9), 1.778 (16:9), 1.850, 2.353, ..." + Environment.NewLine + Languages.Translate("Separate by comma.");
