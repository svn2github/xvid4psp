    ...
    public class Formats
    {
        ...
        private Formats(Format.ExportFormats format)
        {
            ...
            else if (format == Format.ExportFormats.Mkv)
            {
                ...
                this.Muxer = "mkvmerge";
                this.CLI_ffmpeg = "";
                this.CLI_mkvmerge = "[v]-A -S -B -T -M --no-chapters --no-global-tags[/v][a]-D -S -B -T -M --no-chapters --no-global-tags[/a][o]--disable-track-statistics-tags --engage no_cue_duration --engage no_cue_relative_position[/o]";
            ...
            {
                #region MPEG2 PS
                this.VCodecs = new string[] { "MPEG2", "x262" };
                this.VCodecs_IsEditable = true;
                this.Framerates = new string[] { "23.976", "24.000", "25.000", "29.970", "30.000", "50.000", "59.940" };
                this.Framerates_IsEditable = true;
                this.Aspects = new string[] { "1.3333 (4:3)", "1.7778 (16:9)", "1.8500", "2.2100", "2.3529" };
                this.Aspects_IsEditable = true;
                this.MinW = 16; this.MinH = 16;
                this.MidW = 1920; this.MidH = 1088;
                this.MaxW = 1920; this.MaxH = 1088;
            ...
            else if (format == Format.ExportFormats.Custom)
            {
                ...
                this.CLI_ffmpeg = "";
                this.CLI_mkvmerge = "[v]-A -S -B -T -M --no-chapters --no-global-tags[/v][a]-D -S -B -T -M --no-chapters --no-global-tags --language %a_id%:\"%lang%\"[/a][o]--title \"%out_name%\" --disable-track-statistics-tags --engage no_cue_duration --engage no_cue_relative_position[/o]";
