...
namespace XviD4PSP
{
    ...
    public class Massive
    {
        ...
        public Massive Clone()
        {
            ...
            //Ёто решит проблему с неправильным клонированием AudioStreams, но создаст новые проблемы
            //(в некоторых местах аудио параметры обновл€ютс€, не €вно использу€ этот баг)
        ...
        //ѕо умолчанию √истограмма отключена
        ...
        //ѕользовательска€ строчка дл€ mkvmerge
