  ...
  public static class Format
    {
       ...
       public static string GetVCodec(ExportFormats format)
       {
           switch (format)
           {
               ...
               case ExportFormats.Custom:
                   {
                       string[] value = FormatReader.GetFormatInfo("Custom", "GetVCodecs", new string[] { "x264", "MPEG1", "MPEG2",
                       "MPEG4", "FLV1", "MJPEG", "HUFF", "FFV1", "XviD", "DV", "Copy" });
       ...
       public static string GetACodec(ExportFormats format, string vcodec)
       {
           switch (format)
           {
               ...
               case ExportFormats.Custom:
                   {
                       string[] value = FormatReader.GetFormatInfo("Custom", "GetACodecs", new string[] { "PCM", "FLAC", "AAC",
                           "MP2", "MP3", "AC3", "Disabled", "Copy" });
                       if (value != null && value.Length > 0) return value[0];
                       else return null;
                   }
       ...
       //’оть это и из инструкции, но некоторые недопустимые частоты не отлавливаютс€ (42240->32000)
       ...
       public static Massive GetValidFramerate(Massive m)
       {
           ...
           {
               //ѕересчет fps с учетом деинтерлейсера и ограничений форматов
       ...
       {
           //ѕросто выводит предупреждение, если ожидаемый размер файла > 4Gb
