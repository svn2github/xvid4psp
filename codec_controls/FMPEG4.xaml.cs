...
namespace XviD4PSP
{
	public partial class FMPEG4
	{
        ...
        public void LoadFromProfile()
        {
            ...
            combo_fourcc.SelectedItem = m.ffmpeg_options.fourcc_mpeg4;
    ...
    "ITER - iter motion estimation";
            ...
            check_qpel.ToolTip = "Use 1/4 pel motion compensation (Default: Disabled)";
            ...
            check_aic.ToolTip = "H263 advanced intra coding / mpeg4 ac prediction (Default: Disabled)";
            ...
            combo_fourcc.ToolTip = "Force video tag/fourcc (Default: DIVX)";
            //check_ilme.ToolTip = "Interlaced motion estimation";
    ...
    "NSSE - noise preserving sum of squared differences";
        ...
        public static Massive DecodeLine(Massive m)
        {
            ...
            foreach (string value in cli)
            {
                ...
                if (value == "-vtag")
                    m.ffmpeg_options.fourcc_mpeg4 = cli[n + 1];
        ...
        public static Massive EncodeLine(Massive m)
        {
            ...
            if (m.ffmpeg_options.trellis) //тут
                //flags += "+trell";
                line += " -trellis 1 ";

            if (m.ffmpeg_options.gmc)
                flags += "+gmc";
            ...
            line += " -vtag " + m.ffmpeg_options.fourcc_mpeg4;
...
m.encodingmode == Settings.EncodingModes.Quantizer)
        ...
        private void combo_codec_preset_SelectionChanged(object sender, System.Windows.Controls.SelectionChangedEventArgs e)
        {
            if (combo_codec_preset.IsDropDownOpen || combo_codec_preset.IsSelectionBoxHighlighted)
            {
                ...
                if (preset == CodecPresets.Default)
                {
                    ...
                    m.ffmpeg_options.fourcc_mpeg4 = "DIVX";
        ...
        private void check_aic_Checked(object sender, System.Windows.RoutedEventArgs e)
        {
            if (check_aic.IsFocused)
            {
        ...
        private void check_aic_Unchecked(object sender, System.Windows.RoutedEventArgs e)
        {
            if (check_aic.IsFocused)
            {
                m.ffmpeg_options.aic = check_aic.IsChecked.Value;
        ...
        private void combo_fourcc_SelectionChanged(object sender, System.Windows.Controls.SelectionChangedEventArgs e)
        {
            ...
            {
                m.ffmpeg_options.fourcc_mpeg4 = combo_fourcc.SelectedItem.ToString();
                Settings.Mpeg4FOURCC = m.ffmpeg_options.fourcc_mpeg4;
                root_window.UpdateManualProfile();
                DetectCodecPreset();
            }
        }
